...
- ✅ **Змінні (Variables)** - використання ansible_* змінних
...
all:
  hosts:
    ubuntu-test:
      ansible_host: 172.16.246.128  # <-- Змініть IP
      ansible_user: usx             # <-- Змініть користувача
      ansible_port: 22              # <-- Змініть порт (якщо потрібно)
```
