...
type Config struct {
	...
	SSHDefaultUser    string        `yaml:"ssh_default_user" json:"ssh_default_user"`
	SSHDefaultKeyFile string        `yaml:"ssh_default_key_file" json:"ssh_default_key_file"`
	SSHDefaultPort    int           `yaml:"ssh_default_port" json:"ssh_default_port"`
...
// findDefaultSSHKey searches for SSH private keys in standard locations
// Returns the first found key file path, or empty string if none found
func findDefaultSSHKey() string {
	...
	// List of common SSH key files in order of preference
	keyFiles := []string{
		"id_ed25519",
		"id_ecdsa",
		"id_rsa",
...
func DefaultConfig() *Config {
	return &Config{
		...
		SSHDefaultUser:        getEnvString("ONIGIRAZU_SSH_USER", getCurrentUsername()),
		SSHDefaultKeyFile:     getEnvString("ONIGIRAZU_SSH_KEY_FILE", findDefaultSSHKey()),
		SSHDefaultPort:        getEnvInt("ONIGIRAZU_SSH_PORT", 22),
...
func (c *Config) GetSSHDefaultUser() string {
	return c.SSHDefaultUser
}

func (c *Config) GetSSHDefaultKeyFile() string {
	return c.SSHDefaultKeyFile
}

func (c *Config) GetSSHDefaultPort() int {
	return c.SSHDefaultPort
}
